...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen bg-ground flex flex-col md:flex-row overflow-hidden">
      <aside className="w-full md:w-64 bg-primary text-white flex flex-col h-auto md:h-full shrink-0 shadow-xl z-10">
        <div className="p-6">
        ...
        <nav className="flex-1 px-4 space-y-2 overflow-y-auto custom-scrollbar mt-4">
          ...
          <Link href="/admin/payments" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/10 transition-colors font-bold text-sm">
