  ...
  return (
    <div>
      <header className="mb-8 flex items-center justify-between">
        ...
        <div className="bg-accent-purple/10 text-purple-600 dark:text-purple-400 px-4 py-2 rounded-xl font-bold flex items-center gap-2">
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              {payments.map((payment: any) => (
                <tr key={payment.id} className="border-b border-primary/5 hover:bg-ground/50 transition-colors">
                  <td className="p-4">
                  ...
                  <td className="p-4">
                    <a 
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-500/10 text-blue-600 dark:text-blue-400 rounded-lg text-xs font-bold hover:bg-blue-500/20 transition-colors"
                    >
                ...
                <tr>
                  <td colSpan={5} className="p-12 text-center text-gray-500 dark:text-gray-400 font-bold">
                    <div className="flex flex-col items-center justify-center">
                      <div className="w-16 h-16 bg-ground rounded-full flex items-center justify-center mb-4 border border-black/5 dark:border-white/5">
