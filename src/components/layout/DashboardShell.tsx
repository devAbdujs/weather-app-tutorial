...
export const DashboardShell = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="flex h-[100dvh] w-full bg-[#EFEFF3] dark:bg-black justify-center overflow-hidden">
      ...
      <main className="w-full h-full max-w-md bg-ground dark:bg-ground relative shadow-2xl flex flex-col overflow-hidden sm:border-x sm:border-black/5 dark:sm:border-white/5">
