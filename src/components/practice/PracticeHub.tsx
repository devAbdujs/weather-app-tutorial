...
const FRESHMAN_COURSES: Record<string, any[]> = {
  'Natural Science': [
    ...
    { id: 'Entrepreneurship', Icon: Briefcase, color: 'text-sky-600 bg-sky-50' },
  ],
  'Social Science': [
    { id: 'English', Icon: BookOpen, color: 'text-blue-600 bg-blue-50 dark:bg-blue-900/30' },
    { id: 'Psychology', Icon: Brain, color: 'text-violet-600 bg-violet-50 dark:bg-violet-900/30' },
...
const EUEE_SUBJECTS: Record<string, any[]> = {
  'Natural Science': [
    ...
    { id: 'Agriculture', Icon: Globe, color: 'text-green-600 bg-green-100' },
  ],
  'Social Science': [
    { id: 'Mathematics', Icon: Sigma, color: 'text-emerald-600 bg-emerald-50 dark:bg-emerald-900/30' },
    { id: 'English', Icon: BookOpen, color: 'text-rose-600 bg-rose-50 dark:bg-rose-900/30' },
...
const EXIT_DEPARTMENTS = [
  ...
  { id: 'Information Technology (IT)', Icon: Server, color: 'text-cyan-500 bg-cyan-50' },
  ...
  { id: 'Electrical and Computer Engineering', Icon: Zap, color: 'text-yellow-500 bg-yellow-50' },
  { id: 'Chemical Engineering', Icon: FlaskConical, color: 'text-pink-500 bg-pink-50' },
  { id: 'Water Resource Engineering', Icon: Globe, color: 'text-blue-500 bg-blue-50' },
  { id: 'Architecture and Urban Planning', Icon: Building2, color: 'text-stone-500 bg-stone-50' },
  ...
  { id: 'Public Health Science', Icon: HeartHandshake, color: 'text-rose-500 bg-rose-50' },
  { id: 'Sociology', Icon: Users, color: 'text-indigo-500 bg-indigo-50' },
  { id: 'GAT (Graduate Admission Test)', Icon: Brain, color: 'text-violet-500 bg-violet-50 dark:bg-violet-900/30' },
];
